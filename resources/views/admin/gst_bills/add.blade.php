                        ...
                        <form class="form-horizontal" action="{{ url('admin/gst_bills/add') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" placeholder="Invoice No" name="invoice_no" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" placeholder="Total Amount" name="total_amount" id="total_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="checkbox" name="is_interstate" id="is_interstate" value="1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" placeholder="Tax Amount" name="tax_amount" id="tax_amount" class="form-control" readonly required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" step="0.01" name="net_amount" id="net_amount" class="form-control" readonly>
                                    </div>
                                </div>
